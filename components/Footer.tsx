        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/in/brian-biendou-429106201/" target="_blank" rel="noopener noreferrer" aria-label="Mon profil LinkedIn" className="w-10 h-10 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-black transition-colors">
