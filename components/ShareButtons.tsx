...
export default function ShareButtons({ title, slug }: ShareButtonsProps) {
  ...
  const fullUrl = `https://brianbiendou.com/blog/${slug}`
  ...
  return (
    <div className="flex flex-wrap gap-3">
      <a
        ...
        className="flex items-center gap-2 bg-[#0077B5] text-white px-4 py-2 rounded-lg hover:bg-[#006699] transition-colors"
      >
