 ...
 * Sautille toutes les 6 secondes pour attirer l'attention
...
export function SmartLinkButton() {
  ...
  useEffect(() => {
    // Sautiller toutes les 6 secondes
  ...
  return (
    <a
      ...
      className={`fixed bottom-24 right-6 z-50 group hidden md:flex transition-transform duration-300 ${
        isBouncing ? 'animate-bounce-cute' : ''
      }`}
      style={{
        animation: isBouncing ? 'bounce-cute 0.5s ease-in-out 2' : 'none'
      }}
    >
      <style jsx>{`
