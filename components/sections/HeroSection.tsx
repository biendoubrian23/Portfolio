...
export default function HeroSection() {
  return (
    <section id="maison" className="min-h-screen bg-meelo-purple pt-20">
      <div className="max-w-6xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-between py-8">
